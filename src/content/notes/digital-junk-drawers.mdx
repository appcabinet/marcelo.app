---
title: 'Principles of Digital Junk Drawer Design'
description: "A guide to digital junk drawers; how I capture and organize digital artifacts from my daily life."
...
My Roland Fantom S88 located at the back of my old studio.
</NoteImage>
...
# a digital junk drawer is a safe space to capture digital artifacts from your daily life.

This can be absolutely anything: urls, images, notes, feelings, ideas, journal entries, and more. This is a space where ideas can flow uncategorized and in their earliest stages. When an important idea warrants categorization and development, you can move it to where it belongs.
...
Your digital junk drawer should not be more then 2-3 clicks away. If you are a keyboard junky, 1-2 keyboard actions should be enough. Too many steps introduces friction in your capture process, and reduces the chances that anything will get actually get captured in the first place. Bonus points if you can access the junk drawer from your phone too. I've found this extremely helpful for capturing notes from fruitful conversations I have with others.

**Transient**

The dictionary definition of *transient* is "passing with time, transitory" and "remaining in a place only a brief time". Having a new junk drawer each day honours the transitory nature of digital junk drawers, whilst also having them stored somewhere so you can search them whenever you need to.

**Pre-Categorization**

Stuff in your junk drawer shouldn't require categorization. If you know where something belongs, just put it there. Else just focus on capturing; you can organize the important stuff later.

**Shameless**

The quicker you realize that you can put whatever you want in your junk drawer, the sooner it will start to work for you. Get ~~shit~~ stuff off your chest immediately so you can focus on what matters.

**Searchable**

You should be able to search through digital junk. Most note-taking apps make this easy (Just try ⌘+Shift+F). If you can somehow leverage AI to help with this, even better. Although capture is critical, easy retrieval is what makes the system deeply effective in the long run.

**Boundless**

The beautiful thing about digital spaces is that they are virtually limitless. Storage is cheaper than ever, so don't hold back and dump whatever you need.

### My (Dis)organizing Methodology

My note taking tool of choice is Obsidian, and I love it's "daily note" feature. Every day I new note is created with a template of my choice. It allows me to start with a fresh slate, whilst also allowing me to traverse previous days easily. This is my approach however — find a system that works for you.
...
>This is where I write about ideas and things I'm processing. I'll usually fill this in throughout the day as things come up. The idea for this article came up as a journal entry a few weeks ago. Once the idea is written down, you can take it at some point in the future and run with it.
 ...
 <Aside>
 "Productizing" tasks lists doesn't work well because the tasks are *too atomic.* Task-based tools force you to think of tasks as individual units of work to be accomplished, not a fluid list of things to get done.

For this reason I find text documents to be more helpful; they can effortlessly respond to changes in your day-to-day more easily.
 </Aside>
...
(gridded image on left side with my daily notes)
(gridded gif on right that shows me cycling through my daily notes)
...
**MyMind**
A gorgeous web-clipper that helps you save and easily search anything you find online. No note-taking functionality though.

**Obsidian**
This tool changed my life. It allows you to create files and link them together, however you want. That's it.

**Cosmos**
For more visual people, this is a modern pinterest. You can store images, group them, create moodboards, and share with others. Really beautiful.

**Notion**
For those that want to build more robust workflows. Careful because the system can backfire on you — the simpler the better.
